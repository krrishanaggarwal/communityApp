import 'package:community/pages/signupform.dart';
    ...
    try {
      ...
      switch (type) {
        case LoginType.email:
          _returnString =
              await _currentUser.loginInUserWithEmail(email, password);
          break;

        case LoginType.google:
          _returnString = await _currentUser.loginInUserWithGoogle();
          break;
        default:
      }
